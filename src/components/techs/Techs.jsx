import { myReact, techs, techsHeader, html, css, js, git, express, mongo } from "../../constants/words";
    ...
    return (
      <section className="techs" id="techs">
        ...
        <ul className="techs__nav">
            ...
            <li className="icon icon_place_techs"><p>{myReact}</p></li>
            <li className="icon icon_place_techs"><p>{git}</p></li>
            <li className="icon icon_place_techs"><p>{express}</p></li>
            <li className="icon icon_place_techs"><p>{mongo}</p></li>
       </ul>
      </section>
    );
  }
